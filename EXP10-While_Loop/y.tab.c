...
const int YY_parse_CLASS::NTEQ=261;
const int YY_parse_CLASS::EQ=262;
const int YY_parse_CLASS::LT=263;
const int YY_parse_CLASS::GT=264;
const int YY_parse_CLASS::LTEQ=265;
const int YY_parse_CLASS::GTEQ=266;
...
static const short yyprhs[] = {     0,
     0,     7,     9,    13,    15,    19,    21,    23,    25,    27,
    29,    31,    33,    35,    37
};

static const short yyrhs[] = {     3,
    14,    19,    15,    16,    17,     0,    20,     0,    20,    22,
    19,     0,    21,     0,    21,    23,    21,     0,    12,     0,
    13,     0,     4,     0,     5,     0,     6,     0,     7,     0,
     8,     0,    10,     0,     9,     0,    11,     0
};
...
static const char * const yytname[] = {   "$","error","$illegal.","WHILE","AND",
"OR","NTEQ","EQ","LT","GT","LTEQ","GTEQ","ID","NUM","'('","')'","'{'","'}'",
"whileloop","cond","scond","nid","logop","relop",""
};
#endif
...
static const short yypact[] = {     3,
    -3,    -5,-32768,-32768,    -2,     5,    -6,    -4,-32768,-32768,
    -5,-32768,-32768,-32768,-32768,-32768,-32768,    -5,    -1,-32768,
-32768,-32768,    14,    15,-32768
};

static const short yypgoto[] = {-32768,
     6,-32768,     0,-32768,-32768
};
...
static const short yytable[] = {    12,
    13,    14,    15,    16,    17,     1,     3,     4,     9,    10,
     2,    19,     8,    24,    25,    22,    20,    21
};

static const short yycheck[] = {     6,
     7,     8,     9,    10,    11,     3,    12,    13,     4,     5,
    14,    16,    15,     0,     0,    17,    11,    18
};
